...
final class VMConfigurationBuilder: VMConfigurationBuilding {
    ...
    init(
        ...
        configurationValidator: @escaping (VZVirtualMachineConfiguration) throws -> Void = { configuration in
    ...
    private func storageDevices(for metadata: VMMetadata, diskImageURL: URL) throws -> [VZStorageDeviceConfiguration] {
        ...
        var devices: [VZStorageDeviceConfiguration] = [VZVirtioBlockDeviceConfiguration(attachment: diskAttachment)]
    ...
    private func graphicsDevice() -> VZVirtioGraphicsDeviceConfiguration {
        ...
        device.scanouts = [VZVirtioGraphicsScanoutConfiguration(widthInPixels: 1280, heightInPixels: 800)]
        return device
    }
