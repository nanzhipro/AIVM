...
struct VMResourceConfiguration: Codable, Equatable {
    static let light = VMResourceConfiguration(cpuCount: 2, memoryBytes: 4 * 1024 * 1024 * 1024, diskBytes: 32 * 1024 * 1024 * 1024)
    static let standard = VMResourceConfiguration(cpuCount: 4, memoryBytes: 8 * 1024 * 1024 * 1024, diskBytes: 64 * 1024 * 1024 * 1024)
